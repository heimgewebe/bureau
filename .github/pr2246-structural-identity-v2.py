...
marker = "def test_task_revision_identity_guard_rejects_action_only_semantic_inversion"
if marker in tests:
    raise SystemExit("structural identity v2 regressions already present")
tests += '''
